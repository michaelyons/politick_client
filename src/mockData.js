export const mockRecentTopicsFetch = [
  {
    filingId: 301018448,
  ...
  },
  {
    ...
    topic: 'Fiscal Year 2018 US Army Corps Budget, Work Plan and Allocations.',
    lobbyists: [
      {
        name: 'MILAM MABRY',
        id: 2
    ...
    register: 'Mabry Public Affairs LLC'
  },
  {
    filingId: 301018364,
    clientName: 'Andeavor',
  ...
  {
    filingId: 301018224,
    clientName: 'County of Inyo, CA',
    topic: 'Budget appropriations, natural resources, communications',
    lobbyists: [
      {
        name: 'Stephanie Missert',
        id: 9
      },
      {
        name: 'Kristi More',
    ...
    register: 'The Ferguson Group'
  },
  {
    filingId: 301018071,
    clientName: 'Hytera Communication America (West) Inc.',
    topic:
      'H.R. 5515, John McCain National Defense Authorization Act for Fiscal Year 2019, related to all telecommunications matters and S. 2987, John McCain National Defense Authorization Act for Fiscal Year 2019, related to all telecommunications matters.',
    lobbyists: [
      {
        name: 'Christine Hesse',
        id: 10
      }
    ],
    register: 'CALFEE, HALTER & GRISWOLD LLP'
  },
  {
    filingId: 301017609,
    clientName: 'American Iron and Steel Institute',
    topic: 'NHTSA/EPA fuel economy regulations',
    lobbyists: [
      {
  ...
  },
  {
    ...
    topic:
      'Monitor Issues pertaining to healthcare and air medical services. H.R. 3378/S.2121 - Ensuring Access to Air Ambulance Services Act Monitor Issues pertaining to aviation, air medical services, and air tourism. Specific bills include S.1405 - Federal Aviation Reauthorization Act and H.R. 2997 - 21st Century AIRR Act',
    lobbyists: [
      {
        name: 'Scott Eckart',
        id: 5
  ...
  },
  {
    ...
    topic:
      'FY2019 Department of Defense Appropriations Act and FY2019 Department of Homeland Security Appropriations Act; funding issues related to unmanned aerial vehicles (UAVs) and unmanned aerial systems (UASs)',
    lobbyists: [
      {
        name: 'Hadley Sosnoff',
        id: 4
  ...
  },
  {
    ...
    topic:
      'Federal regulation of online lending; impact of Operation Choke Point on nondepository lenders; Consumer Financial Protection Bureau regulations on short-term lending; H.R. 3299; H.R. 4439; H.R. 2706; S.1642',
    lobbyists: [
      {
        name: 'Scott Eckart',
        id: 5
  ...
  {
    filingId: 301016772,
    clientName: 'Tony Strickland Consulting, Inc. for Microsemi Corporation',
    topic: 'DOD Trusted Microelectronics Issues (FPGA)',
    lobbyists: [
      {
        name: 'Morris Thomas, JD',
        id: 14
      },
      {
        name: 'Morris L. Thomas, JD',
        id: 13
      }
    ],
    register: 'MLT Consulting, LLC'
  },
  {
    filingId: 301016471,
  ...
  {
    filingId: 300967595,
    clientName: 'Medical Professional Liability Association',
    topic:
      'Protecting Access to Care Act (regarding federal medical liability reform), H.R. 1215, entire bill; Accessible Care by Curbing Excessive lawSuitS Act (ACCESS Act) (regarding federal medical liability reform), H.R. 1704, entire bill. Good Samaritan Health Professionals Act (regarding ensuring access to care by protecting certain medical volunteers from lawsuits), H.R. 1876, entire bill; Good Samaritan Health Professionals Act (regarding ensuring access to care by protecting certain medical volunteers from lawsuits), S. 781, entire bill;  Pandemic and All-Hazards Preparedness and Advancing Innovation Act, H.R. 6378, Sec. 209 (regarding ensuring access to care by protecting certain medical volunteers from lawsuits);  Pandemic and All-Hazards Preparedness Reauthorization Act, S. 2852, Sec. 207 (regarding healthcare volunteer registration systems) and Sec. 208 (liability related to healthcare volunteers).',
    lobbyists: [
      {
        name: 'Lori Bartholomew',
        id: 26
      },
      {
        name: 'Larry Smarr',
    ...
    register: 'Medical Professional Liability Association'
  },
  {
    filingId: 300935363,
    clientName: 'Robert Bosch LLC',
    topic:
      'Issues related to the adoption of remote patient monitoring technologies. Legislation and agency activities pertaining to Remote Patient Monitoring technologies for veterans health care.  Federal budget for veterans health care funding.  Agency technology requirements for veterans Remote Patent Monitoring devices.',
    lobbyists: [
      {
  ...
  {
    filingId: 300929920,
    clientName: 'National Mining Association',
    topic: 'EPA Clean Water Act regulation',
    lobbyists: [
      {
        name: 'James Rollins',
        id: 28
  ...
  {
    filingId: 300929105,
    clientName: 'Armitage Consulting, LLC (0n behalf of BorgWarner, Inc.)',
    topic:
      'Issues pertaining corporate tax reform in HR 1 (Tax Cut and Jobs Act).',
    lobbyists: [
      {
        name: 'Jeffrey Breneman',
        id: 27
  ...
  {
    filingId: 300928214,
    clientName: 'Vietnam Veterans of America',
    topic:
      'Health Care, Appropriations, Benefits, related to Veterans and their families',
    lobbyists: [
      {
        name: 'Cathleen Wiblemo',
        id: 46
      },
      {
        name: 'Joe Wynn',
      ...
      {
        name: 'Greagory Jacobs',
        id: 40
      },
      {
        name: 'Bethany Keirans',
        id: 39
      },
      {
        name: 'Thomas Burger',
      ...
      {
        name: 'Bethany Kerians',
        id: 29
      }
    ],
    register: 'Vietnam Veterans of America'
  }
];

export const mockWordCloudFetch = [
  {
    text: 'marijuana',
    value: 2
  },
  ...
  {
    text: 'housesenateadministration',
    value: 2
  },
  {
    text: 'actthe',
  ...
  {
    text:
      'httpswwwcmsgovcciioresourcesformsreportsandotherresourcesdownloadslimitedwraparoundcoverageqsinstructionspdf',
    value: 2
  },
  {
    text: 'limited',
